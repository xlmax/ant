...
Введите `/help`, чтобы увидеть локальные команды REPL: `/new`, `/session`, `/clear`, `/exit` и справку по отдельной команде. Вывод разделён цветными блоками; для отключения ANSI-стилей задайте `NO_COLOR=1`.
